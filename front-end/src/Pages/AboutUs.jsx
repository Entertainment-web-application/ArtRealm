              ...
              <div className="relative p-8 space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    recurring donations, and different payment methods (credit
                    card, PayPal, etc.).
                  </p>
                </div>
              </div>
            ...
            <div className="relative group bg-white transition hover:z-[1] hover:shadow-2xl">
              <div className="relative p-8 space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Provide a feature that allows users to track their
                    donations, and see the impact they have made
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative p-8 space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    This allows them to contribute without revealing their
              ...
              >
                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="py-3 sm:py-4">
                    <img
                      src={
                        "https://images.pexels.com/photos/2746824/pexels-photo-2746824.jpeg?auto=compress&cs=tinysrgb&w=600"
                      }
                      alt="an image"
                  ...
                  <div className="py-3 sm:py-4">
                    <img
                      src={
                        "https://images.pexels.com/photos/1108532/pexels-photo-1108532.jpeg?auto=compress&cs=tinysrgb&w=600"
                      }
                      alt=""
                      className="w-full rounded-2xl"
                    />
